...
export const majorArcana: Deck = tarotDeck.filter((card: TarotCard) => {
  card.suit === 'major';
});

export const minorArcana: Deck = tarotDeck.filter((card: TarotCard) => {
  card.suit !== 'major';
});

export const cups: Deck = tarotDeck.filter((card: TarotCard) => {
  card.suit === 'cups';
});

export const wands: Deck = tarotDeck.filter((card: TarotCard) => {
  card.suit === 'wands';
});

export const swords: Deck = tarotDeck.filter((card: TarotCard) => {
  card.suit === 'swords';
});

export const pentacles: Deck = tarotDeck.filter((card: TarotCard) => {
  card.suit === 'pentacles';
});